    ...
    if (!deal || fetchError) {
        return (
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
                ...
                <Link to="/" className="text-violet-600 hover:text-violet-800 dark:text-violet-400 dark:hover:text-violet-300 font-medium hover:underline">
                    &larr; Back to Deals
                </Link>
            </div>
        );
                    ...
                    <div className="p-6 lg:col-span-2">
                        ...
                        <div className="flex flex-wrap items-center gap-4 mb-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700">
                            ...
                            <a
                                ...
                                className="flex-1 sm:flex-none justify-center bg-violet-600 hover:bg-violet-700 text-white px-8 py-2.5 rounded-lg font-bold flex items-center gap-2 transition-colors shadow-sm"
                            >
                                Get Deal
