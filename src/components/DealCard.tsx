    ...
    return (
        <div className="relative bg-white dark:bg-gray-900 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-800 p-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                {/* Image + Vote row on mobile; on desktop this wrapper disappears (contents) so
                    Vote and Image resume their original places via the sm:order-* below */}
                <div className="flex gap-4 sm:contents order-1">
                    {/* Image Section */}
                    ...
                    <div className="flex flex-row sm:flex-col items-center justify-center sm:justify-start gap-3 sm:gap-1 bg-gray-50 dark:bg-gray-800 rounded-lg p-2 flex-1 sm:flex-initial h-24 sm:h-auto sm:min-w-[70px] transition-colors sm:order-1">
                        <VoteButtons
                ...
                <div className="flex-1 min-w-0 order-2 sm:order-3">
                    ...
                    {/* Description (now shown on mobile too, in the space freed by the vote block) */}
                ...
                <div className="flex sm:hidden items-center justify-between gap-3 border-t border-gray-100 dark:border-gray-800 pt-3 order-3">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-violet-600/70 hover:bg-violet-600/80 backdrop-blur-md border border-white/30 text-white py-2 rounded-lg font-medium flex items-center justify-center gap-2 text-sm shadow-lg shadow-violet-600/20 transition-colors"
                    >
                        Go to Deal
                        <ExternalLink size={14} />
                    </a>
                ...
                <div className="hidden sm:block flex-shrink-0 sm:order-4 pr-6">
                    <div className={`flex items-center gap-1 ${getTempColor(temperature)}`}>
